    ...
    <main className="min-h-screen bg-[#f5f0eb] pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-[#0f2c59] mt-8 mb-4">1. Information We Collect</h2>
          <p className="text-gray-600 mb-4">
            BlueberryFin Capital collects information that you provide directly to us, including:
          </p>
          <ul className="list-disc pl-6 text-gray-600 mb-6">
            <li>Name, email address, and contact information</li>
            <li>Company information and financial details</li>
            <li>Communication preferences</li>
            <li>Any other information you choose to provide</li>
          </ul>

          <h2 className="text-2xl font-bold text-[#0f2c59] mt-8 mb-4">2. How We Use Your Information</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-bold text-[#0f2c59] mt-8 mb-4">3. Information Sharing</h2>
          <p className="text-gray-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0f2c59] mt-8 mb-4">4. Data Security</h2>
          <p className="text-gray-600 mb-6">
            We take reasonable measures to help protect your personal information from loss, theft, misuse, unauthorized access, disclosure, alteration, and destruction.
          </p>

          <h2 className="text-2xl font-bold text-[#0f2c59] mt-8 mb-4">5. Your Rights</h2>
          <p className="text-gray-600 mb-6">
